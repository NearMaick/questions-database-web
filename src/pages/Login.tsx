  ...
  return (
    <form onSubmit={handleSubmit(handleAuthenticate)}>
      <div className='mx-auto flex items-center h-screen'>
        <div className='w-[480px] p-6 my-4 mx-auto flex flex-col items-center justify-center bg-gray-200 border dark:bg-gray-800 text-gray-800 dark:text-gray-200 dark:border-white border-black rounded-md'>
