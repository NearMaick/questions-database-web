...
export function Questions() {
  ...
  return (
    <>
      <Header />
      <div className='mx-auto p-2 border dark:border-white border-black rounded-md w-[768px] max-w-[768px]'>
        <div className='p-2 bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-200 h-[130vh]'>
          ...
          <form onSubmit={handleSubmit(handleCreateQuestion)}>
            <div className='flex justify-between mb-2'>
              <label
                className='inline-block text-xl p-2'
                htmlFor='type_question'>
            ...
            {watchTypeQuestion === "none" ? (
              <h1>
                Para finalizar o cadastro da questão, precisa selecionar o
                tipo...
              </h1>
            ) : null}
